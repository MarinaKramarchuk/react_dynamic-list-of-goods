...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://MarinaKramarchuk.github.io/react_dynamic-list-of-goods/) and add it to the PR description.
